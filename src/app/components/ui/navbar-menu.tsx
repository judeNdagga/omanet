...
export const Menu = ({
  ...
  return (
    <nav
      ...
      className="relative rounded-full boder border-transparent dark:bg-black dark:border-white/[0.2] border-gray-400 border-2 shadow-input flex justify-center space-x-4 px-8 py-6 "
    >
      {children}
    </nav>
  );
