  ...
  return (
    <div className="max-w-7xl relative mx-auto py-20 md:py-40 px-4 w-full  left-0 top-0">
      ...
      <p className="max-w-2xl text-base md:text-xl mt-8 dark:text-neutral-200">
        Redefine your wine experience with our handpicked selections, offering a
        symphony of aromas, flavors, and textures that redefine what it means to
        savor wine.
      </p>
    </div>
  );
