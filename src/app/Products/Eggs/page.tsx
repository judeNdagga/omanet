...
export default function Eggs(){
    ...
    return(
      ...
      <div className="bg-white">
        ...
        <div className="card sm:w-[40em] bg-base-100 shadow-xl">
  <figure><img src="https://images.unsplash.com/photo-1586802990181-a5771596eaea?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="Shoes" /></figure>
  <div className="rounded-xl card-body bg-gradient-to-r from-green-900 from-3%
    ...
    <p>High quality eggs from organic farms in Uganda</p>
    <div className="card-actions justify-end pt-5">
      <div className="badge badge-outline">Tray of 12 eggs</div> 
