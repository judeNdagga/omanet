...
export default function BuyWine(){
  ...
  <figure><img src="https://images.unsplash.com/photo-1607709882911-f01030c48427?q=80&w=1951&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="Shoes" /></figure>
  <div className="rounded-xl card-body bg-gradient-to-r from-green-900 from-3%
    ...
    <p>High quality wine from organic farms in Uganda</p>
    <div className="card-actions justify-end pt-5">
      <div className="badge badge-outline">1 Bottle</div> 
